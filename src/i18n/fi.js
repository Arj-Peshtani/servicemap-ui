...
export default {
  ...
  'embedder.height.ratio.description': 'Upotuksen korkeuden suhde leveyteen on määritelty',
  'embedder.height.ratio.label': 'Suhteellinen korkeus',
  'embedder.height.fixed.description': 'Upotuksen korkeus on määritelty pikseleissä',
  'embedder.height.fixed.label': 'Absoluuttinen korkeus',
